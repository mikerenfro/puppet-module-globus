...
class globus::repo::el {
  ...
  exec { 'RPM-GPG-KEY-Globus':
    ...
    command => "wget -qO- ${globus::release_url} | rpm2cpio - | cpio -i --quiet --to-stdout ./etc/pki/rpm-gpg/RPM-GPG-KEY-Globus > /etc/pki/rpm-gpg/RPM-GPG-KEY-Globus", # lint:ignore:140chars
